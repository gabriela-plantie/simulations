...
from mesa import Model, space, time, DataCollector
from agents.orders import OrderStatus, Order
from agents.riders import RiderStatus, Rider
...
class Dispatcher(Model):
    ...
    def step(self):
        ...
        # free_riders = [r for r in self.riders if r.state == RiderStatus.RIDER_FREE]
